...
const OPERATOR_NAME = "国家城市安全发展科技研究院";
const CONTACT_MOBILE = "13826521065";
  ...
  return (
    ...
    >
      <section>
        <h2>一、适用范围与处理主体</h2>
        <p>
          本政策适用于外墙智能巡检平台的网页端、业务接口以及与账号、项目、照片检测和报告有关的服务。
  ...
  return (
    ...
    >
      ...
      <section>
        <h2>二、服务内容</h2>
        <p>
          平台提供外墙检测项目管理、照片上传、辅助缺陷识别、人工复核、检测时段推荐及报告生成、查看和导出功能。
      ...
      <section>
        <h2>五、检测结果</h2>
        <p>
          平台输出用于辅助发现疑似外墙缺陷，受照片质量、拍摄角度、遮挡、识别能力和系统配置影响，可能出现误检、漏检或分类偏差。
